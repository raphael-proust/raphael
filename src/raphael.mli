...
and paper = object
  ...
  method getFont_styled: Js.js_string Js.t -> int -> Js.js_string Js.t -> Attr.font Js.t Js.meth
  method getFont_stretched: Js.js_string Js.t -> int -> Js.js_string Js.t -> Js.js_string Js.t -> Attr.font Js.t Js.meth

  method print: int -> int -> Js.js_string Js.t -> Attr.font Js.t -> int -> set Js.t Js.meth

end


val raphael: Dom.node Js.t -> int -> int -> paper Js.t
val raphael_byId: Js.js_string Js.t -> int -> int -> paper Js.t
val raphael_coord: int -> int -> int -> int -> paper Js.t
